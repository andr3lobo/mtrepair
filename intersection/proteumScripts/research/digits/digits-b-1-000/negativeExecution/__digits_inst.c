...
{ ponta_de_prova (10032, 1);
    return __builtin_bswap32 (__bsx); ponta_de_prova (10032, 2);
} 
static __uint64_t
__bswap_64 (__uint64_t __bsx) 
{ ponta_de_prova (10122, 1);
    return __builtin_bswap64 (__bsx); ponta_de_prova (10122, 2);
} 
union wait
  {
    int w_status;
...
char digit[11]; ponta_de_prova (25003, 1);
    printf("\nEnter an integer > "); 
    scanf("%s",&digit); 
    c=strlen(digit); 
    printf("\n"); 
    for ( i=1; ponta_de_prova (25003, 2), i<c; ponta_de_prova (25003, 3), i++  )
        { 
            if  ( ponta_de_prova (25003, 4), (digit[i]=='-') )
                { 
                    ponta_de_prova (25003, 5);
                    flag1=i; 
                    break; ponta_de_prova (25003, 6);
                } 
            else {
                ponta_de_prova (25003, 7);
                flag1=c; }ponta_de_prova (25003, 8);
        } 
    if  ( ponta_de_prova (25003, 9), (digit[0]=='-') ){
        ponta_de_prova (25003, 10);
        flag2=1; }
    for ( ponta_de_prova (25003, 11), i=flag1-1; ponta_de_prova (25003, 12), i>=flag2; ponta_de_prova (25003, 13), i--  )
        { 
            if  ( ponta_de_prova (25003, 14), (flag2==1 && i==1) ){
                ponta_de_prova (25003, 15);
                printf("-"); }
            ponta_de_prova (25003, 16);
            printf("%c\n", digit[i]); 
        } 
    ponta_de_prova (25003, 17);
    printf("That's all, have a nice day!"); 
    return 0; ponta_de_prova (25003, 18);
} 
