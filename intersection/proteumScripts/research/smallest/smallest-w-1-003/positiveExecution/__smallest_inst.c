...
int main() 
{ 
int A, B, C, D; ponta_de_prova (9940, 1);
    ...
    if ( A < B && A < C && A < D) 
        ...
        if  ( ponta_de_prova (9940, 4), ( B < A && B < C && B < D) )
            { 
            ...
            if  ( ponta_de_prova (9940, 7), ( C < A && C < B && C < D) )
                { 
                ...
                if  ( ponta_de_prova (9940, 10), ( D < A && D < B && D < C ) )
                    { 
                        ponta_de_prova (9940, 11);
                        printf("%i is the smallest\n", D); 
                        return 0; ponta_de_prova (9940, 12);
                    } }}}ponta_de_prova (9940, 16);
} 
