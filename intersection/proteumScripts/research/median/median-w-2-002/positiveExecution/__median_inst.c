...
int main(void) 
{ 
int num1, num2, num3; ponta_de_prova (9940, 1);
    printf("Please enter 3 numbers separated by spaces > "); 
    scanf("%i %i %i", &num1, &num2, &num3); 
    if ((((num1 > num2) && (num1 < num3))) || ((num1 > num3) && (num1 < num2))) 
        { 
            ponta_de_prova (9940, 2);
            printf("%i is the median\n", num1); 
            return 0; ponta_de_prova (9940, 3);
        } 
    else {
        if  ( ponta_de_prova (9940, 4), ((((num2 > num1) && (num2 < num3))) || ((num2 > num3) && (num2 < num1))) )
            { 
                ponta_de_prova (9940, 5);
                printf("%i is the median\n", num2); 
                return 0; ponta_de_prova (9940, 6);
            } 
        else {
            if  ( ponta_de_prova (9940, 7), ((((num3 > num2) && (num3 < num1))) || ((num3 > num1) && (num3 < num2))) )
                { 
                    ponta_de_prova (9940, 8);
                    printf("%i is the median\n", num3); 
                    return 0; ponta_de_prova (9940, 9);
                } }}
    ponta_de_prova (9940, 12);
    return 0; ponta_de_prova (9940, 13);
} 
