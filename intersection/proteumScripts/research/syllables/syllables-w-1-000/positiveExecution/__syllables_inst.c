...
{ 
char in[20]; 
int len,vowels=0,i; ponta_de_prova (13329, 1);
    printf("Please enter a string > "); 
    scanf("%s",in); 
    len=strlen(in); 
    for ( i=0; ponta_de_prova (13329, 2), i<len; ponta_de_prova (13329, 3), i++  )
        { 
            if  ( ponta_de_prova (13329, 4), (in[i]==*("a") || in[i]==*("e") || in[i]==*("o") || in[i]==*("u") ||in[i]==*("y")) )
                { 
                    ponta_de_prova (13329, 5);
                    vowels++; 
                } ponta_de_prova (13329, 6);
        } 
    ponta_de_prova (13329, 7);
    printf("The number of syllables is %d.\n",vowels); 
    return 0; ponta_de_prova (13329, 8);
} 
