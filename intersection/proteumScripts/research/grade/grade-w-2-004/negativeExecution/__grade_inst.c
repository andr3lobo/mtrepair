...
int main() 
{ 
float A,B,C,D,score; ponta_de_prova (9940, 1);
    ...
    if (score >=A) 
        ...
        if  ( ponta_de_prova (9940, 3), (score<A && score>=B) )
            { 
                ponta_de_prova (9940, 4);
                printf("Student has an B grade\n"); 
            } 
        else {
            if  ( ponta_de_prova (9940, 5), (score<B && score>=C) )
                { 
                    ponta_de_prova (9940, 6);
                    printf("Student has an C grade\n"); 
                } 
            else {
                if  ( ponta_de_prova (9940, 7), (score<C && score>=D) )
                    { 
                    ...
                    { 
                        ponta_de_prova (9940, 9);
                        printf("Student has failed the course\n"); 
                    } }}}
    ponta_de_prova (9940, 13);
    return 0; ponta_de_prova (9940, 14);
} 
